...
String[] fields = new String[4];
	 ...
	 */
	public HospitalInfo(String[]fields,Connection con) {
		this.fields = fields;
		this.con = con;
		initialize();
	}
	...
	public void initialize() {
		...
		String clm[]= {"Name","email","bloodtype","contact","city","state"};
		
		JButton btnNewButton = new JButton("Hospital Info");
		...
		btnNewButton.setBounds(23, 61, 138, 25);
		panel.add(btnNewButton);
		
		JButton btnNewButton_2 = new JButton("Reciever Info");
                ...
                if (check.check_data_exist(query)){
                        ...
                        try{
                            ...
                            while (rs.next()) {
                                ...
                                Obj[r][1] =rs.getString("email");
                                Obj[r][2] =rs.getString("bloodtype");
                                Obj[r][3] =rs.getString("contact");
                                Obj[r][4] =rs.getString("city");
                                Obj[r][5] = rs.getString("state");
                                r++;
		...
		JLabel lblNewLabel_1_2 = new JLabel("City  : " + fields[3]);
